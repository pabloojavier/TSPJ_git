...
def main():
    ...
    for group in ['S', 'M', 'L']: #['S', 'M', 'L']:
        for sample in range (1 ,2) : #range (1 ,101) :
            NBC = 'TSPJ_'+ str(sample) + str(group) + '_nodes_table_by_coordinates.csv'
            CoT = 'TSPJ_'+ str(sample) + str(group)+ '_cost_table_by_coordinates.csv'
            TaT = 'TSPJ_'+ str (sample) + str (group)+ '_tasktime_table.csv'
            NNB = 'TSPJ_'+ str (sample) + str (group)+ '_NN_best_route.csv'
            NNBO= 'TSPJ_'+ str(sample) + str(group)+ "_NN_best_route_2opt.csv"
            ...
            print('Sample:',sample,' , ', group, ' , ', node_number,', ' , 'Model: I ' , ' , ' , results [0] , ' , ', results[1],' , ', '%.2f' % (end - start),', ',results[2] ,' , ',results[3],' , ',results[4] ,' , ',results[5] )
            print('Sample:',sample,' , ', group, ' , ', node_number,', ' , 'Model: I ' , ' , ' , results [0] , ' ,', results[1],' , ', '%.2f' % (end - start) ,' ,',results[2] ,' , ',results[3],' , ',results [4] ,' , ',results[5], file = log)
            ...
            print('Sample:',sample,' , ', group, ' , ', node_number,', ' , 'Model: II' , ' , ' , results [0] , ' , ', '%.2f' % (end - start),'', results[1],', ',results[2] ,' , ',results[3],' , ',results [4] ,' , ',results[5] )
            print('Sample:',sample,' , ', group, ' , ', node_number,' , ' , 'Model: II ' , ' , ' , results [0] , ' ,', results[1],' , ', '%.2f' % (end - start) ,', ',results[2] ,' , ',results[3],' , ',results[4] ,' , ',results[5], file = log)
            ...
            print('Sample:',sample,' , ', group, ' , ', node_number,', ' , 'Model: II ', results[1],',' , ' , ' , results [0] , ' , ', '%.2f' % (end - start),', ',results[2] ,' , ',results[3],' , ',results[4] ,' , ',results[5] )
